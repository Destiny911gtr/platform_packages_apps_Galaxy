...
public class ActionPreferences extends preference implements ActionHolder {
    private Defaults mDefaults;
    private ConfigMap mMap;
    private ActionConfig mAction;
    private ActionConfig mDefaultAction;

    public ActionPreferences(Context context) {
        this(context, null);
    }

    public ActionPreferences(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ActionPreferences(Context context, AttributeSet attrs, int defStyleAttr) {
